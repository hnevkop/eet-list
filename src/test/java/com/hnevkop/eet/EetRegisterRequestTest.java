...
import com.hnevkop.eet.sender.EetHeaderDTO;
import com.hnevkop.eet.sender.EetRegisterRequest;
import com.hnevkop.eet.sender.EetSaleDTO;
import org.junit.*;
    ...
    */
	...
	public void simpleRegistrationProcessTest() throws Exception {
		...
		EetRegisterRequest request=EetRegisterRequest.builder()
		   ...
		   .celk_trzba(1.0)
		   .rezim(1)
		   .pkcs12(loadStream(getClass().getResourceAsStream("/1218876223.p12")))
				.pkcs12password("xxxx")
		   //.pkcs12password("eet")
		   .build();
		...
		// PROD
		String response=request.sendRequest(requestBody, new URL("https://prod.eet.cz:443/eet/services/EETServiceSOAP/v3"));
